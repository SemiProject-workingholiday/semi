...
<html lang="ko">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="icon" href="images/semi.png">
  ...
  <body>
      ...
      <div class="container2">
        <div class="logo">
          <a class="navbar-brand" href="#" style='width:160px !important; height: 120px !important; padding:0px;'><img style='width:160px !important; height: 120px !important;' src="images/semi.png"></img></a>
        </div>
        <div class="menu">
          <ul class="nav">
