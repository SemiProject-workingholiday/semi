      ...
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative"
        ...
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <div class="mb-1 text-muted" style="font-size:20px;">사용자가 홈페이지에서 이용하게 될 이름입니다.<br> 개명을 하셨거나 이름을 바꾸길 원하시는 경우
            수정바랍니다.</div><br>
          <label>사용자의 현재 이름 : &nbsp;</label><input type="text" value="khacademy" readonly
    ...
    <div class="col-md-6">
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative"
        ...
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <label>사용자의 현재 연락처 : &nbsp;</label><input type="text" value="010-45xx-33xx" readonly
            style="text-align: center; background: lightgray; border: none; font-weight: 700;">
        </div><br>
          ...
          <form>
            <table>
              ...
              <tr>
                  ...
                  <input type="tel" class="tel" required></td>
              </tr>
            </table>
          </form>
        </div>
