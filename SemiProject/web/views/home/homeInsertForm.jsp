            ...
            <table>
                ...
                <tr> 
                    ...
                    <td>
                        ...
                        <label class="home_option"><input type="radio" name = "home" value="oneroom_apartment"><span>원룸</span></label>
                        <label class="home_option"><input type="radio" name = "home" value="oneroom_apartment"><span>아파트</span></label>
                    </td>
                </tr>
                <tr>
                    <td><b>기간</b></td>
